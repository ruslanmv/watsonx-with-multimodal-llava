...
def read_csv_from_row(csv_file, start_index=44002):
    """
...
# Starting from the 20 000 index:
df_hotels= read_csv_from_row(csv_file_path)#.head(5)  # Read the CSV file into a pandas DataFrame
